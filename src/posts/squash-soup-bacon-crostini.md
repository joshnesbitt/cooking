...
table:
  ...
  from:
    - action: blend until a fine texture
      from:
        - action: simmer together for 10 mins
          from:
            - action: finely chop and soften on a low heat
              from:
                - 2 white onions
                - 6 garlic cloves
                - 1 tbsp dried chilli
            - action: peel, cube and brown in the oven at 220°C
              from:
                - 2 white potatoes
                - 2 butternut squash
            - action: mix into a stock
              from:
                - 1 tbsp bouillon (or 2 vegetable stock cubes)
                - 1.2l boiling water
            - 150ml double cream
    - action: bake at 220°C for 7 minutes so the bacon fat mixes with the bread
      from:
        - action: cube, coat in olive oil and season
          from:
            - 1 ciabatta loaf
            - Olive oil
        - action: slice into small strips
          from:
